...
CREATE PROCEDURE GEDDES.cancelar_dia_agenda(@usuario INT, @fecha Date)
AS
 BEGIN
	DECLARE @profesional INT = (select prof_id from GEDDES.Profesionales where prof_usuario = @usuario)
